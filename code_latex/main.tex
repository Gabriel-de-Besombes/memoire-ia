...
\definecolor{coulGovies}{HTML}{460073}
\definecolor{coulCorp}{HTML}{7500C0}
\definecolor{coulActions}{HTML}{A100FF}
\definecolor{coulImmo}{HTML}{C2A3FF}
\definecolor{coulCash}{HTML}{E6DCFF}
...
\pagenumbering{Roman} % Numérotation en chiffres romains majuscules pour les pages liminaires
